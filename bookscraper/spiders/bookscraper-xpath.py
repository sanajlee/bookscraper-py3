...
class BookScraperXpath(CrawlSpider):
    ...
    rules = (
        Rule(LinkExtractor(restrict_xpaths="//ul[@class='nav nav-list']/li/ul/li/a"), follow=True),
        Rule(LinkExtractor(restrict_xpaths="//article[@class='product_pod']/h3/a"), callback="parse_book")
    )
